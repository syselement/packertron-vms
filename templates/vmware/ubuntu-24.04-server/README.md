...
Adapted from [ynlamy/packer-ubuntuserver24_04](https://github.com/ynlamy/packer-ubuntuserver24_04) (GPLv3). The pristine upstream copy is in `tmp/upstream-originals/`.
